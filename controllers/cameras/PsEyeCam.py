...
class PsEyeCam(Camera):
    ...
    def initialize(self, framerate=10, exposure=1, gain=1, polling_timeout_ms=1000, **kwargs):
        ...
        camera = pseyepy.Camera(int(self._id), fps=framerate, resolution=pseyepy.Camera.RES_LARGE)
        ...
        self.sensor_height = 480 # Hard coded for now, until I can figure out how to get the image size from Camera.RES_LARGE

    def get_frame(self):
        # print("Acquiring frame")
        self._current_frame, _ = self._camera.read()
        # print("Frame acquired")
        if self._current_frame is not None:
            self._image_buffer = self._current_frame
    ...
    def set_exposure_ms(self, exposure):
        ...
        self._camera.exposure = self.exposure_ms
